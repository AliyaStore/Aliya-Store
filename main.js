...
function initializePageScripts() {
    ...
    // WhatsApp Button
    createFloatingButton('whatsappBtn', 'fab fa-whatsapp text-2xl', 'bg-green-500 hover:bg-green-600 text-white pulse-animation', 'bottom-6 right-6', () => window.open('https://wa.me/919773734357?text=Hi! I would like to know more about your bag parts.', '_blank'));
